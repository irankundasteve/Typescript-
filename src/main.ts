...
const deliveredFeatures: Feature[] = [
...
const flowChips = document.querySelector<HTMLDivElement>('#flow-chips');
const flowGrid = document.querySelector<HTMLDivElement>('#flow-grid');
const doneList = document.querySelector<HTMLUListElement>('#done-list');
const missingList = document.querySelector<HTMLUListElement>('#missing-list');
